...
public class TileEntityBrickFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityBrickFurnace.class, new String[] {"Items"}));
    }
